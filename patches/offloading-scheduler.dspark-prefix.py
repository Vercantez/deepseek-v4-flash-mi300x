...
class GroupOffloadConfig(NamedTuple):
    ...
    # DSpark's draft context is rebuilt from target-model hidden states and
...
class RequestOffloadState:
    ...
    # update_state_after_alloc uses this to avoid loading keys that were never
    # confirmed present for the selected prefix boundary.
    ...
    def _lookup(self, req_status: RequestOffloadState) -> int | None:
        ...
        while lookup_groups:
            ...
            for group_idx in groups_iter:
                ...
                if num_hit_chunks == 0:
                    if group_config.eagle_group_is_veto_exempt:
